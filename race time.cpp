...
/*                Problem ID : race time.cpp */
/*             Date: 2022-12-24 14:04:52 */
...
int n,t;
vector<int> str(100005),d(100005);
double onumofint(double mid)
{
    double mn = INT_MAX;
    double mx = INT_MIN;
...
void strolve()
{
   ...
   while(r-l > 0.000000001)
   {
    ...
    double pm1 = onumofint(m1);
    double pm2 = onumofint(m2);
