...
/*                Problem ID : B_Not_stritting.cpp */
/*             Date: 2023-01-09 13:26:49 */
...
void strolve()
{
   ...
   for(int i = 1;i<=r;i++)
   {
    ...
    {
       ll x = i,y =i;
       ll a1 = abstr(x - 1) + abstr(y - 1);
       ll a2 = abstr(x - 1) + abstr(y - c);
       ll a3 = abstr(x - r) + abstr(y - 1);
       ll a4 = abstr(x - r) + abstr(y - c);

       ll mx = max(a1,max(a2,max(a3,a4)));
       anstr.pb(mx);
